...
switch weight_type
    ...
    case 'reweighted'
        ...
        % Weights in JD script - despite different values as in the final
        % reweighted weights set results are almost identical

        % updatedweights=[ 0.000231938709930
        %    0.001422360651870
        %    0.000739277514770
        %    0.000348902666799
        %    0.002015601337998
        ...
        %    0.008275523609205];
        % 
        % updatedweights=repmat(updatedweights,2,1);
end
    ...
    for i=1:nm
        for j=1:nd
            ...
            for z=1 %1:2 
                ...
                [~,~,~,~,rrupt,~,~,~,~,~,~,~,~,~,~,stbran,gsbran,qbran,~,sdbran,~,yt,~]=...
                    textread( ...
                    infile, ...
    ...
    switch model
        case 3 % 3 branches
            ...
            if strcmp(Rtype,'Rjb') && strcmp(weight_type,'original')
                writetable( ...
                    T, ...
                    ['original3bothrjb',char(periods(t)),'_gab.txt'], ...
                    'Delimiter', ...
                    ' ', ...
                    'WriteRowNames', ...
                    true)
            elseif strcmp(Rtype,'Rjb') && strcmp(weight_type,'reweighted')
                writetable( ...
                    T, ...
                    ['reweighted3bothrjb',char(periods(t)),'_gab.txt'], ...
                    'Delimiter', ...
                    ' ', ...
                    'WriteRowNames', ...
                    true)
            elseif strcmp(Rtype,'Rrup') && strcmp(weight_type,'original')
                writetable( ...
                    T, ...
                    ['original3bothrrup',char(periods(t)),'_gab.txt'], ...
                    'Delimiter', ...
                    ' ', ...
                    'WriteRowNames', ...
                    true)
            elseif strcmp(Rtype,'Rrup') && strcmp(weight_type,'reweighted')
                writetable( ...
                    T, ...
                    ['reweighted3bothrrup',char(periods(t)),'_gab.txt'], ...
                    'Delimiter', ...
                    ' ', ...
                    'WriteRowNames', ...
                    true)
        ...
        case 5 % 5 branches
            ...
            if strcmp(Rtype,'Rjb') && strcmp(weight_type,'original')
                writetable( ...
                    T, ...
                    ['original5bothrjb',char(periods(t)),'_gab.txt'], ...
                    'Delimiter', ...
                    ' ', ...
                    'WriteRowNames', ...
                    true)
            elseif strcmp(Rtype,'Rjb') && strcmp(weight_type,'reweighted')
                writetable( ...
                    T, ...
                    ['reweighted5bothrjb',char(periods(t)),'_gab.txt'], ...
                    'Delimiter', ...
                    ' ', ...
                    'WriteRowNames', ...
                    true)
            elseif strcmp(Rtype,'Rrup') && strcmp(weight_type,'original')
                writetable( ...
                    T, ...
                    ['original5bothrrup',char(periods(t)),'_gab.txt'], ...
                    'Delimiter', ...
                    ' ', ...
                    'WriteRowNames', ...
                    true)
            elseif strcmp(Rtype,'Rrup') && strcmp(weight_type,'reweighted')
                writetable( ...
                    T, ...
                    ['reweighted5bothrrup',char(periods(t)),'_gab.txt'], ...
                    'Delimiter', ...
                    ' ', ...
                    'WriteRowNames', ...
                    true)
